...
#########################
#2nd iteration of fire detection model that now allows isolation of the fire pixels     
#and improve the fire detection algorithm
import cv2
import numpy as np
import serial
...
while (video.isOpened()):
    ...
    # print("output:", frame)
    # print(no_red)
    if int(no_red) > 20000 and int(no_red) < 40000:
        print ('Fire detected')
